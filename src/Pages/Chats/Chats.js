            ...
            <form className='mx-7' onSubmit={(e) => {
                ...
                <div className='relative flex'>
                    ...
                    <label className="absolute left-0 text-gray-600 flex items-center px-4 border-l h-full cursor-pointer">
                        <input type="file" className='block w-full text-sm text-zinc-600' src="" alt="i" />
                    ...
                    <button className='absolute right-0 '><IoSend className=' icon icon-tabler icon-tabler-mail rounded-full hover:bg-indigo-100 text-indigo-500 w-10 h-10 p-1' width={18} height={18} onClick={() => { window.alert() }} /></button>
