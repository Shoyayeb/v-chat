...
const TopBar = () => {
  ...
  return (
    <nav className="h-16 flex items-center lg:items-stretch justify-end lg:justify-between bg-white shadow relative z-10 w-full">
          ...
          <div className="w-full flex items-center pl-8 justify-end">
            <div className="h-full w-20 flex items-center justify-center border-r border-l">
              <div className="relative cursor-pointer text-gray-600">
                <IoCall
                  className="text-blue-500 icon icon-tabler icon-tabler-bell"
                  width={28}
                  height={28}
                />
              </div>
            ...
            <div className="h-full w-20 flex items-center justify-center border-r mr-4 cursor-pointer text-gray-600">
              <BsCameraVideoFill
                className="text-blue-500 icon icon-tabler icon-tabler-messages"
                width={28}
                height={28}
              />
            </div>
            <div
              className="flex items-center relative cursor-pointer w-3/12"
