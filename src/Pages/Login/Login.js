        ...
        <Paper sx={{ display: "flex", flexDirection: { md: "row", xs: "column" }, width: "100%", height: "100vh", m: 0 }} style={{ background: "#E9E9E9" }}>
            ...
            <Box sx={{ my: "auto", ml: { md: 20, xs: 5 }, width: 3 / 4, display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
                ...
                <TextField
                    ...
                    color="success"
                />
                <GenerateButton variant="contained" sx={{ display: "flex", flexDirection: "column", fontFamily: "Inter", borderRadius: 10, px: 4 }} color="success" className='generateButton' onClick={() => setLoggedIn(true)}>
                    Login
                </GenerateButton>
            </Box>
        </Paper>
